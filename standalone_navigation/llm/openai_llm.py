"""
OpenAI LLM Implementation - OpenAI GPT-4 Vision API
"""
import requests
import base64
import json
...
class OpenAILLM(BaseLLM):
    """OpenAI LLM implementation for vision analysis and text generation"""
    ...
    def analyze_image(self, image_data: bytes, prompt: str = None) -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.error(f"OpenAI vision analysis error: {e}")
    ...
    def generate_text(self, prompt: str, max_tokens: int = 150) -> str:
        ...
        try:
            ...
            self.logger.error(f"OpenAI text generation error: {e}")
            return "Unable to generate text"
    
    def improve_narration(self, instruction: str, context: str = None) -> str:
        """
        Improve navigation instruction using OpenAI
        ...
        try:
            ...
            self.logger.error(f"OpenAI narration improvement error: {e}")
            return instruction
    
    def _parse_vision_response(self, content: str) -> Dict[str, Any]:
        """
        Parse OpenAI vision response to extract structured data
